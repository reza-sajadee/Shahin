...
class ListViewHoze(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        #توضحات نمایش داده شده در زیر عنوان
        discribtion   = "در این بخش لیست تمام حوزه سازمانی ها را می توانید مشاهده کنید ،جهت جستجو و یا گرفتن خروجی از گزینه های زیر می توانید داستفاده کنید "
        #آیکون نمایش داده شده در بخش بالای سایت
...
class DeleteViewHoze( LoginRequiredMixin,View):
    ...
    def get(self, request,id=None ,*args, **kwargs):
        ...
        if obj is not None:
            ...
            #توضحات نمایش داده شده در زیر عنوان
            discribtion   = "آیا می خواهید که حوزه سازمانی  " + obj.title + " "  + " را پاک کنید   ؟"
            #آیکون نمایش داده شده در بخش بالای سایت            
...
class ListViewRade(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        #توضحات نمایش داده شده در زیر عنوان
        discribtion   = "در این بخش لیست تمام رده سازمانی ها را می توانید مشاهده کنید ،جهت جستجو و یا گرفتن خروجی از گزینه های زیر می توانید داستفاده کنید "
        #آیکون نمایش داده شده در بخش بالای سایت
        icon_name     = "table_chart"
        #تعداد ستون ها
        columns       = 1
...
class DeleteViewRade( LoginRequiredMixin,View):
    ...
    def get(self, request,id=None ,*args, **kwargs):
        ...
        if obj is not None:
            ...
            #توضحات نمایش داده شده در زیر عنوان
            discribtion   = "آیا می خواهید که رده سازمانی  " + obj.title + " "  + " را پاک کنید   ؟"
            #آیکون نمایش داده شده در بخش بالای سایت            
            icon_name     = "delete_forever"
            #تعداد ستون ها            
            color         = "danger"
...
class ListViewDaste(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        #توضحات نمایش داده شده در زیر عنوان
        discribtion   = "در این گروه لیست تمام دسته سازمانی ها را می توانید مشاهده کنید ،جهت جستجو و یا گرفتن خروجی از گزینه های زیر می توانید داستفاده کنید "
        #آیکون نمایش داده شده در بخش بالای سایت
        icon_name     = "table_chart"
        #تعداد ستون ها
        columns       = 1
...
class DeleteViewDaste( LoginRequiredMixin,View):
    ...
    def get(self, request,id=None ,*args, **kwargs):
        ...
        if obj is not None:
            ...
            #توضحات نمایش داده شده در زیر عنوان
            discribtion   = "آیا می خواهید که دسته سازمانی  " + obj.title + " "  + " را پاک کنید   ؟"
            #آیکون نمایش داده شده در بخش بالای سایت            
            icon_name     = "delete_forever"
            #تعداد ستون ها            
            color         = "danger"
...
class ListViewBakhsh(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        #توضحات نمایش داده شده در زیر عنوان
        discribtion   = "در این گروه لیست تمام بخش سازمانی ها را می توانید مشاهده کنید ،جهت جستجو و یا گرفتن خروجی از گزینه های زیر می توانید داستفاده کنید "
        #آیکون نمایش داده شده در بخش بالای سایت
        icon_name     = "table_chart"
        #تعداد ستون ها
        columns       = 1
...
class DeleteViewBakhsh( LoginRequiredMixin,View):
    ...
    def get(self, request,id=None ,*args, **kwargs):
        ...
        if obj is not None:
            ...
            #توضحات نمایش داده شده در زیر عنوان
            discribtion   = "آیا می خواهید که بخش سازمانی  " + obj.title + " "  + " را پاک کنید   ؟"
            #آیکون نمایش داده شده در بخش بالای سایت            
            icon_name     = "delete_forever"
            #تعداد ستون ها            
            color         = "danger"
...
class ListViewVahed(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        #توضحات نمایش داده شده در زیر عنوان
        discribtion   = "در این بخش لیست تمام واحد سازمان  ها را می توانید مشاهده کنید ،جهت جستجو و یا گرفتن خروجی از گزینه های زیر می توانید داستفاده کنید "
        #آیکون نمایش داده شده در بخش بالای سایت
        icon_name     = "table_chart"
        #تعداد ستون ها
        columns       = 1
...
class DeleteViewVahed( LoginRequiredMixin,View):
    ...
    def get(self, request,id=None ,*args, **kwargs):
        ...
        if obj is not None:
            ...
            #توضحات نمایش داده شده در زیر عنوان
            discribtion   = "آیا می خواهید که واحد سازمان   " + obj.title + " "  + " را پاک کنید   ؟"
            #آیکون نمایش داده شده در بخش بالای سایت            
            icon_name     = "delete_forever"
            #تعداد ستون ها            
            color         = "danger"
...
class ListViewSatheVahed(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        #توضحات نمایش داده شده در زیر عنوان
        discribtion   = "در این بخش لیست تمام سطح واحد سازمانی ها را می توانید مشاهده کنید ،جهت جستجو و یا گرفتن خروجی از گزینه های زیر می توانید داستفاده کنید "
        #آیکون نمایش داده شده در بخش بالای سایت
        icon_name     = "table_chart"
        #تعداد ستون ها
        columns       = 1
...
class DeleteViewSatheVahed( LoginRequiredMixin,View):
    ...
    def get(self, request,id=None ,*args, **kwargs):
        ...
        if obj is not None:
            ...
            #توضحات نمایش داده شده در زیر عنوان
            discribtion   = "آیا می خواهید که سطح واحد سازمانی  " + obj.title + " "  + " را پاک کنید   ؟"
            #آیکون نمایش داده شده در بخش بالای سایت            
            icon_name     = "delete_forever"
            #تعداد ستون ها            
            color         = "danger"
...
class DeleteViewTypePostSazmani( LoginRequiredMixin,View):
    ...
    def get(self, request,id=None ,*args, **kwargs):
        ...
        if obj is not None:
            ...
            #توضحات نمایش داده شده در زیر عنوان
            discribtion   = "آیا می خواهید که نوع پست سازمانی  " + obj.title + " "  + " را پاک کنید   ؟"
            #آیکون نمایش داده شده در بخش بالای سایت            
            icon_name     = "delete_forever"
            #تعداد ستون ها            
            color         = "danger"
...
class ListViewIndexMahaleKhedmat(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        #توضحات نمایش داده شده در زیر عنوان
        discribtion   = "در این بخش لیست تمام   ایندکس محل خدمت را می توانید مشاهده کنید ،جهت جستجو و یا گرفتن خروجی از گزینه های زیر می توانید داستفاده کنید "
        #آیکون نمایش داده شده در بخش بالای سایت
        icon_name     = "table_chart"
        #تعداد ستون ها
        columns       = 1
...
class DeleteViewIndexMahaleKhedmat( LoginRequiredMixin,View):
    ...
    def get(self, request,id=None ,*args, **kwargs):
        ...
        if obj is not None:
            ...
            #توضحات نمایش داده شده در زیر عنوان
            discribtion   = "آیا می خواهید که  ایندکس محل حدمت  " + obj.title + " "  + " را پاک کنید   ؟"
            #آیکون نمایش داده شده در بخش بالای سایت            
            icon_name     = "delete_forever"
            #تعداد ستون ها            
            color         = "danger"
...
class DeleteViewJobBank( LoginRequiredMixin,View):
    ...
    def get(self, request,id=None ,*args, **kwargs):
        ...
        if obj is not None:
            ...
            header_title  = "پاک کردن یک نوع پست سازمانی"
            #توضحات نمایش داده شده در زیر عنوان
            discribtion   = "آیا می خواهید که نوع پست سازمانی  " + str(obj.profile) + " "  + " را پاک کنید   ؟"
            #آیکون نمایش داده شده در بخش بالای سایت            
            icon_name     = "delete_forever"
            #تعداد ستون ها            
            color         = "danger"
...
class ListViewPost(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        #توضحات نمایش داده شده در زیر عنوان
        discribtion   = "در این بخش لیست تمام پست سازمان  ها را می توانید مشاهده کنید ،جهت جستجو و یا گرفتن خروجی از گزینه های زیر می توانید داستفاده کنید "
        #آیکون نمایش داده شده در بخش بالای سایت
        icon_name     = "table_chart"
        #تعداد ستون ها
        columns       = 1
...
class DeleteViewPost( LoginRequiredMixin,View):
    ...
    def get(self, request,id=None ,*args, **kwargs):
        ...
        if obj is not None:
            ...
            #توضحات نمایش داده شده در زیر عنوان
            discribtion   = "آیا می خواهید که پست سازمان   " + obj.title + " "  + " را پاک کنید   ؟"
            #آیکون نمایش داده شده در بخش بالای سایت            
            icon_name     = "delete_forever"
            #تعداد ستون ها            
            color         = "danger"
