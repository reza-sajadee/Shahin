...
class ListViewNahiye(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        #توضحات نمایش داده شده در زیر عنوان
        discribtion   = "در این بخش لیست تمام ناحیه فرآیندی ها را میتوانید مشاهده کنید ،جهت جستجو و یا گرفتن خروجی از گزینه های زیر میتوانید داستفاده کنید "
        #آیکون نمایش داده شده در بخش بالای سایت
...
class DeleteViewNahiye( LoginRequiredMixin,View):
    ...
    def get(self, request,id=None ,*args, **kwargs):
        ...
        if obj is not None:
            ...
            #توضحات نمایش داده شده در زیر عنوان
            discribtion   = "آیا میخواهید که ناحیه فرآیندی  " + obj.title + " "  + " را پاک کنید   ؟"
            #آیکون نمایش داده شده در بخش بالای سایت            
...
class ListViewGroup(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        #توضحات نمایش داده شده در زیر عنوان
        discribtion   = "در این گروه لیست تمام فرآیند ها را میتوانید مشاهده کنید ،جهت جستجو و یا گرفتن خروجی از گزینه های زیر میتوانید داستفاده کنید "
        #آیکون نمایش داده شده در بخش بالای سایت
        icon_name     = "table_chart"
        #تعداد ستون ها
        columns       = 1
...
class DeleteViewGroup( LoginRequiredMixin,View):
    ...
    def get(self, request,id=None ,*args, **kwargs):
        ...
        if obj is not None:
            ...
            #توضحات نمایش داده شده در زیر عنوان
            discribtion   = "آیا میخواهید که فرآیند  " + obj.title + " "  + " را پاک کنید   ؟"
            #آیکون نمایش داده شده در بخش بالای سایت            
            icon_name     = "delete_forever"
            #تعداد ستون ها            
            color         = "danger"
...
class ListViewProcess(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        #توضحات نمایش داده شده در زیر عنوان
        discribtion   = "در این گروه لیست تمام گروه فرآیندی ها را میتوانید مشاهده کنید ،جهت جستجو و یا گرفتن خروجی از گزینه های زیر میتوانید داستفاده کنید "
        #آیکون نمایش داده شده در بخش بالای سایت
        icon_name     = "table_chart"
        #تعداد ستون ها
        columns       = 1
...
class DeleteViewProcess( LoginRequiredMixin,View):
    ...
    def get(self, request,id=None ,*args, **kwargs):
        ...
        if obj is not None:
            ...
            #توضحات نمایش داده شده در زیر عنوان
            discribtion   = "آیا میخواهید که گروه فرآیندی  " + obj.title + " "  + " را پاک کنید   ؟"
            #آیکون نمایش داده شده در بخش بالای سایت            
            icon_name     = "delete_forever"
            #تعداد ستون ها            
            color         = "danger"
...
class ListViewHoze(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        #توضحات نمایش داده شده در زیر عنوان
        discribtion   = "در این بخش لیست تمام بخش فرآیندی ها را میتوانید مشاهده کنید ،جهت جستجو و یا گرفتن خروجی از گزینه های زیر میتوانید داستفاده کنید "
        #آیکون نمایش داده شده در بخش بالای سایت
        icon_name     = "table_chart"
        #تعداد ستون ها
        columns       = 1
...
class DeleteViewHoze( LoginRequiredMixin,View):
    ...
    def get(self, request,id=None ,*args, **kwargs):
        ...
        if obj is not None:
            ...
            #توضحات نمایش داده شده در زیر عنوان
            discribtion   = "آیا میخواهید که بخش فرآیندی  " + obj.title + " "  + " را پاک کنید   ؟"
            #آیکون نمایش داده شده در بخش بالای سایت            
            icon_name     = "delete_forever"
            #تعداد ستون ها            
            color         = "danger"
...
class ListViewProcessDocument(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        #توضحات نمایش داده شده در زیر عنوان
        discribtion   = "در این بخش لیست تمام سند فرآیند  ها را میتوانید مشاهده کنید ،جهت جستجو و یا گرفتن خروجی از گزینه های زیر میتوانید داستفاده کنید "
        #آیکون نمایش داده شده در بخش بالای سایت
        icon_name     = "table_chart"
        #تعداد ستون ها
        columns       = 1
...
class ViewProcessDocument( LoginRequiredMixin,View):
    ...
    def get(self, request,id=None ,*args, **kwargs):
        ...
        if obj is not None:
            ...
            #توضحات نمایش داده شده در زیر عنوان
            discribtion   = "چزییات سند فرآیند را در این صفحه میتوانید مشاهده کنید"
            #آیکون نمایش داده شده در بخش بالای سایت            
            icon_name     = "person_add"
            #تعداد ستون ها            
            color         = "info"
...
class DeleteViewProcessDocument( LoginRequiredMixin,View):
    ...
    def get(self, request,id=None ,*args, **kwargs):
        ...
        if obj is not None:
            ...
            #توضحات نمایش داده شده در زیر عنوان
            discribtion   = "آیا میخواهید که سند فرآیند   " + obj.process.title + " "  + " را پاک کنید   ؟"
            #آیکون نمایش داده شده در بخش بالای سایت            
            icon_name     = "delete_forever"
            #تعداد ستون ها            
            color         = "danger"
...
class ListViewProcessDescription(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        #توضحات نمایش داده شده در زیر عنوان
        discribtion   = "در این بخش لیست تمام توضیحات فرآیند  ها را میتوانید مشاهده کنید ،جهت جستجو و یا گرفتن خروجی از گزینه های زیر میتوانید داستفاده کنید "
        #آیکون نمایش داده شده در بخش بالای سایت
        icon_name     = "table_chart"
        #تعداد ستون ها
        columns       = 1
...
class ViewProcessDescription( LoginRequiredMixin,View):
    ...
    def get(self, request,id=None ,*args, **kwargs):
        ...
        if obj is not None:
            ...
            #توضحات نمایش داده شده در زیر عنوان
            discribtion   = "چزییات توضیحات فرآیند را در این صفحه میتوانید مشاهده کنید"
            #آیکون نمایش داده شده در بخش بالای سایت            
            icon_name     = "person_add"
            #تعداد ستون ها            
            color         = "info"
...
class DeleteViewProcessDescription( LoginRequiredMixin,View):
    ...
    def get(self, request,id=None ,*args, **kwargs):
        ...
        if obj is not None:
            ...
            #توضحات نمایش داده شده در زیر عنوان
            discribtion   = "آیا میخواهید که توضیحات فرآیند   " + obj.ProcessDocumentRelated.process.title + " "  + " را پاک کنید   ؟"
            #آیکون نمایش داده شده در بخش بالای سایت            
            icon_name     = "delete_forever"
            #تعداد ستون ها            
            color         = "danger"
