...
class MostanadatKharejiFilter(django_filters.FilterSet):
    ...
    publishedDate = django_filters.DateFilter(field_name='publishedDate', label="تاریخ انتشار")

    class Meta:
        model = MostanadatKhareji
        fields = ['title', 'processCode', 'refrenceName', 'publishedDate']
    ...
    def __init__(self, data=None, queryset=None, *, request=None, prefix=None):
        ...
        self.filters['publishedDate'].field.widget.attrs.update({'class': 'form-control'})
