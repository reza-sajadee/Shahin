...
class ListViewPositionLevelList(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        #توضحات نمایش داده شده در زیر عنوان
        discribtion   = "در این بخش لیست تمام سطح سازمانی ها را می توانید مشاهده کنید ،جهت جستجو و یا گرفتن خروجی از گزینه های زیر می توانید داستفاده کنید "
        #آیکون نمایش داده شده در بخش بالای سایت
...
class DeleteViewPositionLevelList( LoginRequiredMixin,View):
    ...
    def get(self, request,id=None ,*args, **kwargs):
        ...
        if obj is not None:
            ...
            #توضحات نمایش داده شده در زیر عنوان
            discribtion   = "آیا می خواهید که سطح سازمانی  " + obj.title + " "  + " را پاک کنید   ؟"
            #آیکون نمایش داده شده در بخش بالای سایت            
