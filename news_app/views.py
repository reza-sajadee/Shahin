...
class ListViewCategoriy(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        #توضحات نمایش داده شده در زیر عنوان
        discribtion   = "در این بخش لیست تمام دسته بندی خبر  ها را می توانید مشاهده کنید ،جهت جستجو و یا گرفتن خروجی از گزینه های زیر می توانید داستفاده کنید "
        #آیکون نمایش داده شده در بخش بالای سایت
...
class ViewCategoriy( LoginRequiredMixin,View):
    ...
    def get(self, request,id=None ,*args, **kwargs):
        ...
        if obj is not None:
            ...
            #توضحات نمایش داده شده در زیر عنوان
            discribtion   = "چزییات دسته بندی خبر را در این صفحه می توانید مشاهده کنید"
            #آیکون نمایش داده شده در بخش بالای سایت            
            icon_name     = "person_add"
            #تعداد ستون ها            
            color         = "info"
...
class DeleteViewCategoriy( LoginRequiredMixin,View):
    ...
    def get(self, request,id=None ,*args, **kwargs):
        ...
        if obj is not None:
            ...
            #توضحات نمایش داده شده در زیر عنوان
            discribtion   = "آیا می خواهید که دسته بندی خبر   " + obj.title + " "  + " را پاک کنید   ؟"
            #آیکون نمایش داده شده در بخش بالای سایت            
...
class ListViewNews(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        #توضحات نمایش داده شده در زیر عنوان
        discribtion   = "در این بخش لیست تمام خبر  ها را می توانید مشاهده کنید ،جهت جستجو و یا گرفتن خروجی از گزینه های زیر می توانید داستفاده کنید "
        #آیکون نمایش داده شده در بخش بالای سایت
        icon_name     = "table_chart"
        #تعداد ستون ها
        columns       = 1
...
class ViewNews( LoginRequiredMixin,View):
    ...
    def get(self, request,id=None ,*args, **kwargs):
        ...
        if obj is not None:
            ...
            #توضحات نمایش داده شده در زیر عنوان
            discribtion   = "چزییات خبر را در این صفحه می توانید مشاهده کنید"
            #آیکون نمایش داده شده در بخش بالای سایت            
            icon_name     = "person_add"
            #تعداد ستون ها            
            color         = "info"
...
class DeleteViewNews( LoginRequiredMixin,View):
    ...
    def get(self, request,id=None ,*args, **kwargs):
        ...
        if obj is not None:
            ...
            #توضحات نمایش داده شده در زیر عنوان
            discribtion   = "آیا می خواهید که خبر   " + obj.title + " "  + " را پاک کنید   ؟"
            #آیکون نمایش داده شده در بخش بالای سایت            
            icon_name     = "delete_forever"
            #تعداد ستون ها            
            color         = "danger"
